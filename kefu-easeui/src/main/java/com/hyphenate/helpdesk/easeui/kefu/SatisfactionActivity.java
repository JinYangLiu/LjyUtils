...
import com.hyphenate.helpdesk.easeui.kefu.flow.FlowTagLayout;
import com.hyphenate.helpdesk.easeui.kefu.flow.OnTagSelectListener;
...
public class SatisfactionActivity extends BaseActivity {
    ...
    private CircularImage imageViewPhotoKefu;
    private TextView textViewNameKefu;
    ...
    protected void onCreate(Bundle arg0) {
        ...
        refreshFlowLayout();
        //設置頭像
        UserUtil.setNickAndAvatar(getApplicationContext(),currentMessage,imageViewPhotoKefu,textViewNameKefu);
    ...
    private void initView() {
        ...
        imageViewPhotoKefu =  findViewById(R.id.imageView_photo_kefu);
        textViewNameKefu =  findViewById(R.id.textView_name_kefu);
        tvLevelName = (TextView) findViewById(R.id.tv_level_name);
