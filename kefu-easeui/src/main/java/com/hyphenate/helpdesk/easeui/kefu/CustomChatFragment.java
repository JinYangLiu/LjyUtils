...
//        titleBar.setLeftImageResource(R.drawable.icon_back_gray);
...
//            }
//        });
//        titleBar.setRightImageResource(R.drawable.icon_title_delete);
        titleBar.setTitle("安心客服");
        titleBar.setRightImageResource(R.drawable.icon_title_delete);
        titleBar.setTitleColor(ContextCompat.getColor(getContext(), R.color.color_0xDD));
        titleBar.setLeftLayoutClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (CommonUtils.isSingleActivity(getActivity())) {
...
//        Log.i("tag",msg );
//        if (msg.contains("anxin:")) {
//            startActivity(new Intent(getActivity(), BbsSignInNewActivity.class));
//        }
        return false;
    }
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_CODE_SELECT_MAP) {
                ...
                if (locationAddress != null && !locationAddress.equals("")) {
                    ...
                    Toast.makeText(getActivity(), "Unable to get to your location information!", Toast.LENGTH_SHORT).show();
                }
