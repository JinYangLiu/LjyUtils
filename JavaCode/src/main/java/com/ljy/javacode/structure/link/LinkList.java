...
public class LinkList {
    private Link<String> first;//LinkList仅包含了一个数据项，即对第一个链结点的引用
    ...
    public Link<String> find(String value){
        Link current=first;
    ...
    public Link<String> delete(String value){
