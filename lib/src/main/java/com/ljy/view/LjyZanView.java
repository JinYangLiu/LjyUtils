...
public class LjyZanView extends LinearLayout implements Animator.AnimatorListener {
    ...
    public LjyZanView(Context context) {
        this(context, null);
    }

    public LjyZanView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LjyZanView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        imageDis.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mOnClickCallBack!=null)
                    mOnClickCallBack.listenerDisLike();
            }
        });
    ...
    public void animBack() {
        ...
        animatorBack.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                LayoutParams paramsLike = new LinearLayout.LayoutParams(defalutSize, defalutSize);
                LayoutParams paramsDisLike = new LinearLayout.LayoutParams(defalutSize, defalutSize);

                if (like > disLike) {
                    paramsLike.bottomMargin = magrin;
                    paramsDisLike.bottomMargin = magrin * disLike / like;
                } else {
                    paramsDisLike.bottomMargin = magrin;
                    paramsLike.bottomMargin = magrin * like / disLike;
                }

                if (paramsLike.bottomMargin <= like * 4) {
                    imageLike.setLayoutParams(paramsLike);
                }
                if (paramsDisLike.bottomMargin <= disLike * 4) {
                    imageDis.setLayoutParams(paramsDisLike);
                }
            }
        });
        isClose = false;
    ...
    public LjyZanView setDefalutBottom(int defalutBottom) {
    ...
    public LjyZanView setDividerMargin(int dividerMargin) {
