...
public class LjyJigsawView extends RelativeLayout implements View.OnClickListener {
    ...
    public LjyJigsawView(Context context) {

        this(context, null);
    }

    public LjyJigsawView(Context context, AttributeSet attrs) {

        this(context, attrs, 0);
    }

    public LjyJigsawView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.JigsawView);
        drawableId = typedArray.getResourceId(R.styleable.JigsawView_jigsawSrc, R.drawable.cat);
        jigsawSelectColor = typedArray.getColor(R.styleable.JigsawView_jigsawSelectColor, 0x88ff8888);
        init();
    }
    ...
    public void onClick(View v) {
        ...
        if (mFirst == null) {
            mFirst = (ImageView) v;
            //设置选中效果
            mFirst.setColorFilter(jigsawSelectColor);
            //第二次点击
        } else {
            mSecond = (ImageView) v;
            //交换
