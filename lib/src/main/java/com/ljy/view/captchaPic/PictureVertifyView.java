...
public class PictureVertifyView extends AppCompatImageView {
    ...
    void setMode(@LjyCaptchaPictureView.Mode int mode) {
        this.mMode = mode;
        this.blockShape = null;
        this.blockInfo = null;
        this.shadowInfo = null;
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN && mMode == LjyCaptchaPictureView.MODE_NONBAR) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (mMode == LjyCaptchaPictureView.MODE_NONBAR && verfityBlock != null) {
            float x = event.getX();
            float y = event.getY();
