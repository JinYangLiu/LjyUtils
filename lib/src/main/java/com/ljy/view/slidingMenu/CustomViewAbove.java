...
public class CustomViewAbove extends ViewGroup {
    ...
    private LjySlidingMenu.OnClosedListener mClosedListener;
    private LjySlidingMenu.OnOpenedListener mOpenedListener;
     ...
     */
    public void setOnOpenedListener(LjySlidingMenu.OnOpenedListener l) {
        mOpenedListener = l;
    }

    public void setOnClosedListener(LjySlidingMenu.OnClosedListener l) {
        mClosedListener = l;
    }
    ...
    protected int mTouchMode = LjySlidingMenu.TOUCHMODE_MARGIN;
    ...
    private boolean thisTouchAllowed(MotionEvent ev) {
        ...
        if (isMenuOpen()) {
            ...
            switch (mTouchMode) {
                ...
                case LjySlidingMenu.TOUCHMODE_NONE:
                    return false;
    ...
    public void scrollTo(int x, int y) {
        ...
        ((LjySlidingMenu) getParent()).manageLayers(getPercentOpen());
    }
