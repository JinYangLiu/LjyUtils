...
public class LjyChineseToPinyinUtil {
    ...
    private static LjyChineseToPinyinUtil characterParser = new LjyChineseToPinyinUtil();

    public static LjyChineseToPinyinUtil getInstance() {
