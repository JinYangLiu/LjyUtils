...
public class MainActivity extends BaseActivity {
    ...
    private void initData() {
        String[] textArr = new String[]{"Utils的使用", "GlideUtil的使用", "setViewSize的使用", "手势锁view的使用", "雷达图view的使用",
                ...
                "Lottie的demo", "calendar的demo", "ballView的使用", "贝塞尔曲线的使用", "app更新", "夜间模式","DataBinding的使用","一个涂鸦画板"};
        ...
        Class[] classArr = new Class[]{UseUtilsActivity.class, GlideUtilActivity.class, ViewSizeActivity.class,
                ...
                BallActivity.class, BezierActivity.class, AppUpdateActivity.class,null, BindDataActivity.class, DoodleActivity.class};
